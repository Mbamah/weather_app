    ...
    <View style={styles.container}>
      ...
      source ={require ('../assets/images/5246774.jpg')}
        ...
        <View style={{flexDirection:"row", }}>
          <Feather name="circle" style={{marginRight:15}} size={11} color="#888" />
          <FontAwesome name="circle"  size={11} color="#1278D6" />
        </View>

          {/* Buttons */}
      <View style={{  top: 40, flexDirection:'row', alignItems:"center", justifyContent:'space-between'}}> 
          <TouchableOpacity style={{backgroundColor:'#1278D6', borderRadius:5,}}>
            <Text onPress={()=>{
              navigation.navigate('Home')
            }} style={{color:'white', padding:10, fontSize: 16, fontFamily:'Pop'}}>DONE</Text>
          </TouchableOpacity>
